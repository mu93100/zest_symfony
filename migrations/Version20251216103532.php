 ...
 */
final class Version20251216103532 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE montant_adhesion CHANGE montant montant INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE montant_adhesion CHANGE montant montant VARCHAR(255) NOT NULL');
    }
}
