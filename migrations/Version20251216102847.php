 ...
 */
final class Version20251216102847 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE dispo CHANGE libelle_dispo libelle VARCHAR(200) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE dispo CHANGE libelle libelle_dispo VARCHAR(200) NOT NULL');
    }
}
