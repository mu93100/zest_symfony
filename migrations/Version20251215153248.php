 ...
 */
final class Version20251215153248 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE groupe CHANGE adresse_distribution adresse_distrib VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE groupe CHANGE adresse_distrib adresse_distribution VARCHAR(255) DEFAULT NULL');
    }
}
