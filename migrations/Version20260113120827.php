 ...
 */
final class Version20260113120827 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE media ADD page VARCHAR(50) DEFAULT NULL, ADD recette_id INT DEFAULT NULL, ADD produit_id INT DEFAULT NULL, ADD ressource_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE media ADD CONSTRAINT FK_6A2CA10C89312FE9 FOREIGN KEY (recette_id) REFERENCES recette (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE media DROP page, DROP recette_id, DROP produit_id, DROP ressource_id');
    }
}
